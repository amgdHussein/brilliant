...
import { ForbiddenException, InternalServerErrorException, NotFoundException, UnauthorizedException } from '../exceptions';

type AppException = ForbiddenException | NotFoundException | UnauthorizedException | InternalServerErrorException;
